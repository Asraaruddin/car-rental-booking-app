...
const Dashboard = () => {
  ...
  return (
    <div className='px-4 pt-10 md:px-10 flex-1'>
        ...
        <div className='grid md:grid-cols-2 items-start gap-6 mb-8 w-full '>
            {/* recent booking */}
            <div className='p-4 m:p-6 border border-borderColor rounded-md flex-1 min-w-64'>
            ...
            {/* monthly revenue */}
            <div className='p-3 m:p-6 border border-borderColor rounded-md max-w-xs w-full'>
