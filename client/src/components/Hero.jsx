...
const Hero = () => {
  ...
  return (
    <div className='h-screen flex flex-col items-center justify-center gap-14 bg-light text-center'>
        <h1 className='text-4xl md:text-5xl font-semibold mt-10'>Luxury cars on Rent</h1>
<form className="flex flex-col md:flex-row items-center justify-between p-6 rounded-lg md:rounded-full w-full max-w-2xl bg-white shadow-[0px_8px_20px_rgba(0,0,0,0.1)]">
...
<img src={assets.main_car} alt="car" className="max-h-[300px] w-auto object-contain" />      
    </div>
  )
}
